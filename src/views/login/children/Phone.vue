<template>
  <div class="phone-container">
    <Input class="phone" type="tel" v-model="loginForm.phone" @clearClick="loginForm.phone = ''" :error="error.phone"
           placeholder="请输入手机号码"/>
    <Input class="password" type="password" :showpassword="true" v-model="loginForm.password" :error="error.password"
           @clearClick="loginForm.password = ''" placeholder="请输入密码"/>
